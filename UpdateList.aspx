<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="UpdateList.aspx.vb" Inherits="SafeCookSmartShop.UpdateList" %>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" readonly class="form-control" id="ListName"
                                   placeholder="List Name" runat="server">
                            </div>
                          </div>
