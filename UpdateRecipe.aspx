<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="UpdateRecipe.aspx.vb" Inherits="SafeCookSmartShop.UpdateRecipe" %>
                ...
                <div class="row">
                    <div class="main_mix_content text-center sections">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" readonly class="form-control" id="recipeName"
                                   placeholder="Recipe Name" runat="server">
                            </div>
                          </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <asp:FileUpload ID="uploadPicture" ToolTip="Currently unable to upload pictures" enabled="false" runat="server" CssClass="for-control" />
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group text-right row">
                            <button type="submit" class="btn" style="background-color:#ddd;border-color:black;" runat="server" id ="btnUpdate">Update</button>
